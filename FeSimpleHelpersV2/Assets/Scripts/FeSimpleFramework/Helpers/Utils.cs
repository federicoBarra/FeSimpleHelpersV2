...
public static class Utils
{
	...
	public static int BetterRandom(int min, int maxNonInclusive, bool keepSeed = false)
	{
	...
	public static float BetterRandom(float min, float max)
	{
	...
	public static T GiveRandom<T>(T[] list) where T : Object
	{
		...
		int rnd = BetterRandom(0, list.Length);
		return list[rnd];
	}
	...
	public static T GiveRandom<T>(List<T> list) where T: Object
	{
		...
		int rnd = BetterRandom(0, list.Count);
		return list[rnd];
	}
