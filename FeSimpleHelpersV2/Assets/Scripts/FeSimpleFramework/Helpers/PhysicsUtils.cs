...
public static class PhysicsUtils
{
    ...
    public static void AngledOverlapSphereNonAlloc32(Transform caller, Vector3 pos, Vector3 dir, float angle, float range, LayerMask hittablesLayer, List<GameObject> hittables)
    {
