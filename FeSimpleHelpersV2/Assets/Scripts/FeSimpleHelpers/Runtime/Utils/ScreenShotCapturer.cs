...
{
	/// <summary>
	/// Screenshot taker class. "Screenshots/" folder must exist in the project for it to work.
	/// It has some legacy code from an old project.
	/// TODO cleanup
	/// TODO add it to default cheat system
	/// </summary>
...
#if UNITY_EDITOR
		[UnityEditor.MenuItem("FeSimpleHelpers/Take GameView Screenshot")]
