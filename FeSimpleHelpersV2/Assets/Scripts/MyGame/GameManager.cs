...
{
	/// <summary>
	/// This object handles the overall game flow and state
	...
	public class GameManager : MonoBehaviourSingleton<GameManager>
	{
		...
		{
			base.AwakeSingleton();
			//TODO Mygame.GetInherit.StartPlayState();
		...
		{
			//TODO Mygame..GetInherit.EndPlayState();
		}

		void Update()
		{
			//TODO Mygame..GetInherit.Process();
		}

		//public void ListenStory()
		//{
		//	if (UserProfiles.Get().CurrentProfile.HasStartedAnyStory)
		//		GoToLobby();
		//	else
		//		FirstTimePlaying();
		//}
		...
		public virtual void LoadFromCurrentProfile()
		{
			...
			//Call SyncFromProfile on needed objects
		}

		public virtual void SaveToCurrentProfile()
		{
			UserProfiles.UserProfile currentUserProfile = UserProfiles.Get().CurrentProfile;
			//Call SyncToProfile on needed objects
